...
func TestMarshalUnmarshalDiskIOWindow(t *testing.T) {
	v := DiskIOWindow{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgDiskIOWindow(b *testing.B) {
	v := DiskIOWindow{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgDiskIOWindow(b *testing.B) {
	v := DiskIOWindow{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalDiskIOWindow(b *testing.B) {
	v := DiskIOWindow{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeDiskIOWindow(t *testing.T) {
	v := DiskIOWindow{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeDiskIOWindow Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeDiskIOWindow(b *testing.B) {
	v := DiskIOWindow{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeDiskIOWindow(b *testing.B) {
	v := DiskIOWindow{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
